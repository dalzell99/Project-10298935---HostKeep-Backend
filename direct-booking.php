...
<div id='directBookingAddNewBooking'>
	<table>
		...
		<tr>
			<td>
				<input id='directBookingAddCheckIn' type='text' date='' />
			</td>
			<td>
				<input id='directBookingAddCheckOut' type='text' date='' />
			</td>
		</tr>
...
<div id="directBookingCalendarContainer">
	<span class="closeIcon" onclick="$('#directBookingCalendarContainer').hide();">&#10006;</span>
